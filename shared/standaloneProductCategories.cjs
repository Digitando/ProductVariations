  ...
  beauty_cosmetics: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_Skincare_Laboratory',
          title: 'Clinical skincare laboratory',
          description: 'Serums and creams styled with lab glassware in pristine lighting.',
          prompt:
            'Photograph my skincare serums and creams arranged with laboratory glassware, petri dishes, and pipettes on a glossy white surface. Use cool clinical lighting with soft reflections to communicate efficacy. No text or people.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Fragrance_Velvet',
          title: 'Velvet fragrance spotlight',
          description: 'Perfume bottle on velvet drapery with dramatic spotlight.',
          prompt:
            'Create a cinematic studio hero shot of my fragrance bottle resting on deep velvet drapery with a focused spotlight carving out highlights in the glass. Add subtle backlight haze for atmosphere. No text or hands.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  health_supplements: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_Gummy_Sunburst',
          title: 'Citrus gummy vitamins burst',
          description: 'Chewable vitamins with citrus slices in bright sunlight.',
          prompt:
            'Photograph my gummy vitamins spilling from a jar onto a glass plate surrounded by sliced citrus and mint leaves on a sunlit countertop. Use vibrant daylight and crisp highlights to emphasize freshness. No text or people.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Protein_Shaker_Pour',
          title: 'Protein shake in motion',
          description: 'Protein powder pouring into a clear shaker with gym accents.',
          prompt:
            'Create a dynamic studio hero shot of my protein powder being poured into a transparent shaker with a measured scoop mid-air. Set on a matte black surface with gym towel and headphones as accents. Freeze motion with controlled lighting, no text.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  fitness_sport: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_Apparel_Locker',
          title: 'Locker room apparel display',
          description: 'Training apparel styled on lockers with steam ambiance.',
          prompt:
            'Create a studio-inspired locker room scene showcasing my performance apparel hanging neatly with coordinated shoes and a towel on a bench. Add subtle steam and rim lighting to highlight technical fabrics. No people or logos.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Cardio_MotionBlur',
          title: 'Cardio machine energy streaks',
          description: 'Treadmill or bike with light trails conveying motion.',
          prompt:
            'Photograph my cardio machine on a dark floor with LED light trails streaking behind to imply speed. Use controlled accent lighting to outline the frame and keep surroundings minimal. No people or text.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  electronics: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_Smartphone_ColorSweep',
          title: 'Smartphone color sweep',
          description: 'Phone angled with sweeping colored light accents.',
          prompt:
            'Create a studio hero shot of my smartphone floating above a reflective surface with sweeping neon light gradients wrapping around the edges to showcase its finish. Keep the background dark and graphic. No UI or text.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Laptop_SlimProfile',
          title: 'Ultrathin laptop profile',
          description: 'Laptop lid half-open highlighting thin silhouette.',
          prompt:
            'Photograph my ultrathin laptop half-open on a brushed metal platform with a razor-thin side profile emphasized by rim lighting. Cool ambient glow and clean reflections. No screen content or text.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  mobile_accessories: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_Case_ColorWall',
          title: 'Case color wall',
          description: 'Phone cases clipped to a grid wall with bold colors.',
          prompt:
            'Photograph my collection of phone cases clipped to a geometric wall grid with bold color blocks and spotlight accents. Keep alignment precise and surfaces matte. No text or devices inside the cases.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Charging_GlowDock',
          title: 'Illuminated charging dock',
          description: 'Wireless chargers glowing on reflective base.',
          prompt:
            'Create a studio hero shot of my wireless chargers arranged on a reflective base with soft underlighting and faint energy rings projected on the surface. Keep the environment minimal and tech-forward. No text.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  computing_gaming: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_RGB_HeadsetStand',
          title: 'Headset on illuminated stand',
          description: 'Gaming headset glowing on an RGB pedestal.',
          prompt:
            'Create a studio hero image of my gaming headset resting on an illuminated stand with RGB light strips tracing the base. Dark mirrored surface with colorful reflections, no text.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Console_Exploded',
          title: 'Exploded console lineup',
          description: 'Console with cartridges or game cases in motion.',
          prompt:
            'Photograph my game console with cartridges or game cases appearing to float outward in a dynamic arc. Use dramatic spot lighting and shallow depth of field to focus on branding areas. No text overlays.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  home_appliances: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_AirFryer_SteamBurst',
          title: 'Air fryer steam burst',
          description: 'Air fryer releasing steam with plated food props.',
          prompt:
            'Photograph my air fryer on a kitchen counter with its basket slightly open releasing a gentle steam burst, surrounded by plated vegetables and herbs. Warm directional lighting suggests fresh cooking. No people or text.',
        },
        {
          idSuffix: '21',
          name: 'Studio_SmartCleaner_Dock',
          title: 'Smart cleaner docking scene',
          description: 'Robot vacuum docking with subtle ambient glow.',
          prompt:
            'Create a studio-style vignette of my robot vacuum gliding into its charging dock on a polished floor with a soft ambient glow along the baseboard. Minimalist setting, cool highlights, no text.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  furniture_decor: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_Seating_Sunwash',
          title: 'Sun-washed seating hero',
          description: 'Lounge chair lit by angled sunlight and shadow patterns.',
          prompt:
            'Create a studio hero photograph of my lounge chair positioned where angled sunlight casts architectural shadows across the upholstery. Emphasize curves and stitching with warm highlights. No people or text.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Decor_GalleryWall',
          title: 'Gallery wall decor story',
          description: 'Wall art and accents styled with layered frames and objects.',
          prompt:
            'Photograph my wall decor set against a painted accent wall with layered frames, shelves, and sculptural accents arranged in a gallery-style composition. Soft diffused lighting, no people.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  home_living: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_Bedding_Bedscape',
          title: 'Sunrise bedding bedscape',
          description: 'Fully made bed with layered linens and morning glow.',
          prompt:
            'Photograph my bedding set on a fully made bed with layered duvets, pillows, and throws basking in warm sunrise light spilling across the headboard. Keep styling minimal and inviting. No people or text.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Kitchenware_Flatlay',
          title: 'Culinary flatlay spread',
          description: 'Top-down flatlay of cookware with seasonal ingredients.',
          prompt:
            'Create a top-down studio flatlay of my kitchenware set arranged with seasonal produce, herbs, and utensils on a stone slab. Use directional light to carve gentle shadows and keep the scene tidy. No text.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  food_beverage: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_Smoothie_Tower',
          title: 'Vibrant smoothie tower',
          description: 'Layered smoothies and superfoods in bright daylight.',
          prompt:
            'Photograph my health food powders and smoothies stacked in glass jars with vibrant layers, surrounded by fresh fruits and seeds on a white marble surface. Bright daylight and crisp styling, no text.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Coffee_BeanCascade',
          title: 'Coffee bean cascade',
          description: 'Coffee beans pouring around packaging with warm light.',
          prompt:
            'Create a studio hero shot of my coffee packaging with a cascade of roasted beans frozen mid-air around the bag and a steaming cup beside it. Warm, moody lighting with controlled highlights. No text.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  kids_products: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_Stroller_CityGlow',
          title: 'City glow stroller hero',
          description: 'Stroller framed by city lights with reflective floor.',
          prompt:
            'Photograph my stroller on a reflective black floor with blurred city lights glowing in the background, emphasizing modern design and safety features. Use cool rim lighting, no people or text.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Toy_ColorBurst',
          title: 'Color burst toy pile',
          description: 'Vibrant toy pile with confetti and spotlight.',
          prompt:
            'Create a studio hero shot of my toys piled in a colorful burst surrounded by suspended confetti and balloons against a bright seamless backdrop. Even playful lighting, no text.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  toys_hobbies: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_BoardGame_Action',
          title: 'Board game action hero',
          description: 'Pieces mid-move with motion blur trails.',
          prompt:
            'Photograph my board game with pieces captured mid-move using gentle motion blur trails and directional lighting to convey excitement. Keep the board crisp and background minimal. No text.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Model_Lightbox',
          title: 'Model lightbox showcase',
          description: 'Scale model glowing inside a lightbox.',
          prompt:
            'Create a studio hero shot of my scale model displayed inside a translucent lightbox with cool edge lighting illuminating contours. Dark surroundings for contrast, no text.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  automotive: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_Tire_SnowStack',
          title: 'Winter tire stack',
          description: 'Stacked tires with snow particles and cold lighting.',
          prompt:
            'Photograph my stack of winter tires dusted with artificial snow on a dark concrete surface, illuminated with cool blue rim lights to emphasize tread. Add subtle falling snow particles, no vehicle or text.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Detailing_Foam',
          title: 'Foam wash spotlight',
          description: 'Detailing bottle with foam plume and accessories.',
          prompt:
            'Create a studio hero shot of my detailing shampoo bottle with a foam cannon nozzle spraying a dramatic plume against a dark backdrop. Include microfiber towels and brushes at the base. No text or vehicles.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  pet_products: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_PetBed_Sunbeam',
          title: 'Sunbeam pet bed hero',
          description: 'Pet bed in warm sunlight with cozy textiles.',
          prompt:
            'Photograph my pet bed positioned in a warm sunbeam with layered blankets and toys on a wooden floor, capturing soft shadows and inviting textures. No animals or text.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Treat_Tower',
          title: 'Treat tower display',
          description: 'Stacked treats and chews with playful accents.',
          prompt:
            'Create a studio hero shot of my pet treats stacked into a playful tower with scattered bones and paw-print props on a colorful seamless backdrop. Even lighting, no animals.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  diy_tools: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_Workshop_Sparks',
          title: 'Workshop sparks hero',
          description: 'Power tool cutting with frozen sparks.',
          prompt:
            'Photograph my power tool slicing through metal on a workbench with golden sparks frozen mid-air against a darkened workshop backdrop. Use directional lighting for drama, no people.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Material_ColorGrid',
          title: 'Material color grid',
          description: 'Material swatches arranged in precise grid.',
          prompt:
            'Create a studio flatlay of my materials—paint chips, tiles, fabric samples—arranged in a precise color grid on a white board with soft top lighting and crisp shadows. No text.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  books_education: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_Rainbow_Bookcase',
          title: 'Rainbow spine bookcase',
          description: 'Books ordered by color on minimalist shelving.',
          prompt:
            'Photograph my book collection arranged by color on floating shelves against a neutral wall with soft daylight washing across the spines. Include a few decor accents, no people or text.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Digital_CourseHub',
          title: 'Digital course workstation',
          description: 'Tablet and headset styled for online learning.',
          prompt:
            'Create a studio hero shot of my tablet displaying a blank course interface alongside headphones, notebook, and stylus on a sleek desk with cool LED edge lighting. No screen content or text.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  music_instruments: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_Guitar_AmpGlow',
          title: 'Guitar amp glow hero',
          description: 'Guitar leaning on amp with glowing tubes.',
          prompt:
            'Create a studio hero shot of my guitar leaning against a tube amplifier with the amp lights glowing through the grille and a smoky stage haze. Dramatic rim lighting, no people.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Vinyl_Spin',
          title: 'Spinning vinyl close-up',
          description: 'Turntable captured mid-spin with stylus detail.',
          prompt:
            'Photograph my turntable with vinyl spinning under a spotlight, capturing motion blur on the record and a sharply focused stylus. Dark moody backdrop, no text.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  outdoor_travel: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_Tent_Starfield',
          title: 'Starfield tent vignette',
          description: 'Tent glowing under starry projected backdrop.',
          prompt:
            'Create a studio hero shot of my tent glowing from within against a projected starfield backdrop with cool blue lighting and light mist on the floor. Emphasize structure and fabric texture, no people.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Backpack_RainShield',
          title: 'Backpack rain shield hero',
          description: 'Backpack with rain cover and water droplets.',
          prompt:
            'Photograph my backpack with its rain cover deployed, beads of water cascading off the fabric under directional lighting on a wet stone surface. Dark moody background, no people.',
        },
      ],
      'Lifestyle Scenes': [
        {
  ...
  seasonal_products: {
    ...
    groups: {
      'Studio Hero Shots': [
        ...
        {
          idSuffix: '20',
          name: 'Studio_Halloween_Smoke',
          title: 'Halloween smoke spotlight',
          description: 'Costume accessories with smoky lighting and pumpkins.',
          prompt:
            'Create a studio hero shot of my Halloween costume accessories arranged with pumpkins and skull props on a dark surface while wisps of orange smoke swirl behind them. Dramatic lighting, no people.',
        },
        {
          idSuffix: '21',
          name: 'Studio_Summer_Poolside',
          title: 'Poolside summer hero',
          description: 'Summer essentials on reflective aqua surface.',
          prompt:
            'Photograph my summer essentials—sunscreen, sunglasses, towel—arranged on a reflective aqua surface with rippled light patterns mimicking pool water. Bright, cheerful lighting, no people.',
        },
      ],
      'Lifestyle Scenes': [
        {
...
const SUBCATEGORY_ASSIGNMENTS = {
  beauty_cosmetics: {
    '*': 'ALL',
    Studio_TopDown_Grid: ['beauty_cosmetics_makeup', 'beauty_cosmetics_skincare'],
    Studio_Perfume_Glow: ['beauty_cosmetics_fragrances'],
    Studio_Mirror_Reflection: ['beauty_cosmetics_makeup', 'beauty_cosmetics_fragrances'],
    Lifestyle_Spa_Bathroom: ['beauty_cosmetics_skincare'],
    Lifestyle_Bag_Flatlay: ['beauty_cosmetics_makeup'],
    Lifestyle_Bedside_Routine: ['beauty_cosmetics_skincare', 'beauty_cosmetics_fragrances'],
    Lifestyle_Bath_Towels: ['beauty_cosmetics_skincare'],
    Detail_Texture_Swatch: ['beauty_cosmetics_makeup', 'beauty_cosmetics_skincare'],
    Detail_Dropper: ['beauty_cosmetics_skincare'],
    Detail_Perfume_Atomizer: ['beauty_cosmetics_fragrances'],
    Detail_Brush_Bristles: ['beauty_cosmetics_makeup'],
    Detail_Drop_Texture: ['beauty_cosmetics_skincare', 'beauty_cosmetics_fragrances'],
    Studio_Skincare_Laboratory: ['beauty_cosmetics_skincare'],
    Studio_Fragrance_Velvet: ['beauty_cosmetics_fragrances'],
  },
  health_supplements: {
    '*': 'ALL',
    Studio_Powder_Scoop: ['health_supplements_proteins', 'health_supplements_dietary'],
    Studio_Capsule_Floating: ['health_supplements_vitamins', 'health_supplements_dietary'],
    Lifestyle_Gym_Bag: ['health_supplements_proteins'],
    Lifestyle_Green_Smoothie: ['health_supplements_proteins', 'health_supplements_dietary'],
    Lifestyle_Nightstand: ['health_supplements_vitamins'],
    Detail_Tablet_Texture: ['health_supplements_vitamins', 'health_supplements_dietary'],
    Detail_Powder_Texture: ['health_supplements_proteins'],
    Detail_Capsule_Split: ['health_supplements_vitamins', 'health_supplements_dietary'],
    Detail_Lid_Seal: ['health_supplements_proteins', 'health_supplements_dietary'],
    Studio_Gummy_Sunburst: ['health_supplements_vitamins'],
    Studio_Protein_Shaker_Pour: ['health_supplements_proteins'],
  },
  fitness_sport: {
    '*': 'ALL',
    Studio_Gear_Set: ['fitness_sport_equipment'],
    Studio_Apparel_Mannequin: ['fitness_sport_apparel'],
    Studio_Tread_Motion: ['fitness_sport_machines'],
    Studio_Mat_Stack: ['fitness_sport_equipment', 'fitness_sport_apparel'],
    Studio_Spotlight_Dumbbell: ['fitness_sport_equipment'],
    Lifestyle_Gym_Setup: ['fitness_sport_equipment', 'fitness_sport_machines'],
    Lifestyle_Outdoor_Track: ['fitness_sport_apparel'],
    Lifestyle_Yoga_LivingRoom: ['fitness_sport_apparel', 'fitness_sport_equipment'],
    Lifestyle_Garage_Gym: ['fitness_sport_equipment', 'fitness_sport_machines'],
    Lifestyle_Park_Workout: ['fitness_sport_apparel', 'fitness_sport_equipment'],
    Detail_Fabric_Tech: ['fitness_sport_apparel'],
    Detail_Handle_Grip: ['fitness_sport_equipment'],
    Detail_Control_Interface: ['fitness_sport_machines'],
    Detail_Sole_Tread: ['fitness_sport_apparel', 'fitness_sport_equipment'],
    Detail_Band_Texture: ['fitness_sport_equipment'],
    Studio_Apparel_Locker: ['fitness_sport_apparel'],
    Studio_Cardio_MotionBlur: ['fitness_sport_machines'],
  },
  electronics: {
    '*': 'ALL',
    Studio_Open_Device: ['electronics_laptops', 'electronics_tablets'],
    Studio_Screen_Glow: ['electronics_smartphones', 'electronics_tablets'],
    Studio_Disassembled_Set: ['electronics_smartphones', 'electronics_laptops'],
    Lifestyle_Workspace: ['electronics_laptops', 'electronics_tablets'],
    Lifestyle_Couch_Relax: ['electronics_tablets'],
    Lifestyle_OnTheGo: ['electronics_smartphones', 'electronics_tablets'],
    Lifestyle_Creative_Desk: ['electronics_laptops', 'electronics_tablets'],
    Lifestyle_CoffeeShop: ['electronics_laptops', 'electronics_tablets'],
    Detail_Port_Finish: ['electronics_laptops', 'electronics_tablets'],
    Detail_Camera_Module: ['electronics_smartphones', 'electronics_tablets'],
    Detail_Keyboard_Texture: ['electronics_laptops'],
    Detail_Vent_Finish: ['electronics_laptops'],
    Detail_Button_Profile: ['electronics_smartphones', 'electronics_tablets'],
    Studio_Smartphone_ColorSweep: ['electronics_smartphones'],
    Studio_Laptop_SlimProfile: ['electronics_laptops'],
  },
  mobile_accessories: {
    '*': 'ALL',
    Studio_Case_Display: ['mobile_accessories_cases'],
    Studio_Charging_Set: ['mobile_accessories_chargers'],
    Studio_Audio_Buds: ['mobile_accessories_audio'],
    Studio_Color_Block: ['mobile_accessories_cases', 'mobile_accessories_audio'],
    Studio_Floating_Cables: ['mobile_accessories_chargers', 'mobile_accessories_audio'],
    Lifestyle_Desk_Setup: ['mobile_accessories_chargers', 'mobile_accessories_audio'],
    Lifestyle_Nightstand: ['mobile_accessories_chargers'],
    Lifestyle_OnTheGo: ['mobile_accessories_cases', 'mobile_accessories_audio'],
    Lifestyle_CarConsole: ['mobile_accessories_chargers'],
    Lifestyle_Bedside_Mood: ['mobile_accessories_chargers', 'mobile_accessories_audio'],
    Detail_Case_Texture: ['mobile_accessories_cases'],
    Detail_Cable_Connector: ['mobile_accessories_chargers'],
    Detail_Buds_Close: ['mobile_accessories_audio'],
    Detail_MagSafe_Ring: ['mobile_accessories_cases', 'mobile_accessories_chargers'],
    Detail_Cable_Braid: ['mobile_accessories_chargers'],
    Studio_Case_ColorWall: ['mobile_accessories_cases'],
    Studio_Charging_GlowDock: ['mobile_accessories_chargers'],
  },
  computing_gaming: {
    '*': 'ALL',
    Studio_Setup_RGB: ['computing_gaming_keyboards', 'computing_gaming_mice'],
    Studio_Console_Duo: ['computing_gaming_consoles'],
    Studio_Component_Close: ['computing_gaming_keyboards', 'computing_gaming_mice'],
    Studio_Controller_Ring: ['computing_gaming_consoles'],
    Studio_Dual_Monitor: ['computing_gaming_keyboards', 'computing_gaming_mice'],
    Lifestyle_Battlestation: ['computing_gaming_keyboards', 'computing_gaming_mice'],
    Lifestyle_WorkspaceHybrid: ['computing_gaming_keyboards', 'computing_gaming_mice'],
    Lifestyle_CouchGaming: ['computing_gaming_consoles'],
    Lifestyle_LAN_Party: ['computing_gaming_keyboards', 'computing_gaming_mice'],
    Lifestyle_Portable_Gaming: ['computing_gaming_consoles'],
    Detail_Keycap: ['computing_gaming_keyboards'],
    Detail_Mouse_Scroll: ['computing_gaming_mice'],
    Detail_Controller_Button: ['computing_gaming_consoles'],
    Detail_RGB_Fan: ['computing_gaming_keyboards', 'computing_gaming_mice'],
    Detail_Headset_Cushion: ['computing_gaming_keyboards', 'computing_gaming_mice', 'computing_gaming_consoles'],
    Studio_RGB_HeadsetStand: ['computing_gaming_keyboards', 'computing_gaming_mice', 'computing_gaming_consoles'],
    Studio_Console_Exploded: ['computing_gaming_consoles'],
  },
  home_appliances: {
    '*': 'ALL',
    Studio_Countertop_Appliance: ['home_appliances_kitchen'],
    Studio_Appliance_Parts: ['home_appliances_kitchen', 'home_appliances_cleaning'],
    Studio_Cutaway_Glow: ['home_appliances_kitchen', 'home_appliances_homecare'],
    Studio_Glass_Surface: ['home_appliances_homecare'],
    Studio_Ingredient_Surround: ['home_appliances_kitchen'],
    Lifestyle_Kitchen_Action: ['home_appliances_kitchen'],
    Lifestyle_Cleaning_Closet: ['home_appliances_cleaning'],
    Lifestyle_Breakfast_Scene: ['home_appliances_kitchen', 'home_appliances_homecare'],
    Lifestyle_Dinner_Prep: ['home_appliances_kitchen'],
    Lifestyle_Coffee_Bar: ['home_appliances_homecare', 'home_appliances_kitchen'],
    Detail_Control_Knob: ['home_appliances_kitchen', 'home_appliances_homecare'],
    Detail_Blade_Texture: ['home_appliances_kitchen'],
    Detail_Material_Finish: ['home_appliances_homecare', 'home_appliances_cleaning'],
    Detail_Filter: ['home_appliances_cleaning', 'home_appliances_homecare'],
    Detail_Cord_Wrap: ['home_appliances_cleaning', 'home_appliances_homecare'],
    Studio_AirFryer_SteamBurst: ['home_appliances_kitchen'],
    Studio_SmartCleaner_Dock: ['home_appliances_cleaning', 'home_appliances_homecare'],
  },
  furniture_decor: {
    '*': 'ALL',
    Studio_Chair_Pedestal: ['furniture_decor_seating'],
    Studio_Lighting_Focus: ['furniture_decor_lighting'],
    Studio_Decor_Flatlay: ['furniture_decor_accents'],
    Studio_Textile_Drape: ['furniture_decor_seating', 'furniture_decor_accents'],
    Studio_Pedestal_Group: ['furniture_decor_accents', 'furniture_decor_lighting'],
    Lifestyle_LivingRoom: ['furniture_decor_seating', 'furniture_decor_accents'],
    Lifestyle_Corner_Vignette: ['furniture_decor_lighting', 'furniture_decor_accents'],
    Lifestyle_Table_Setting: ['furniture_decor_accents', 'furniture_decor_lighting'],
    Lifestyle_Bedroom_Nook: ['furniture_decor_lighting', 'furniture_decor_seating'],
    Lifestyle_Patio_Glow: ['furniture_decor_seating', 'furniture_decor_lighting'],
    Detail_Wood_Grain: ['furniture_decor_seating', 'furniture_decor_accents'],
    Detail_Lamp_Shade: ['furniture_decor_lighting'],
    Detail_Decor_Surface: ['furniture_decor_accents'],
    Detail_Seam_Close: ['furniture_decor_seating'],
    Detail_Surface_Inlay: ['furniture_decor_accents'],
    Studio_Seating_Sunwash: ['furniture_decor_seating'],
    Studio_Decor_GalleryWall: ['furniture_decor_accents', 'furniture_decor_lighting'],
  },
  home_living: {
    '*': 'ALL',
    Studio_Bedding_Stack: ['home_living_bedding'],
    Studio_Rug_Section: ['home_living_rugs'],
    Studio_Kitchenware_Set: ['home_living_kitchenware'],
    Studio_Textile_Tiers: ['home_living_bedding', 'home_living_rugs'],
    Studio_Tabletop_Display: ['home_living_kitchenware'],
    Lifestyle_Bedroom_Cozy: ['home_living_bedding'],
    Lifestyle_Kitchen_Prep: ['home_living_kitchenware'],
    Lifestyle_Rug_Living: ['home_living_rugs'],
    Lifestyle_Bath_Retreat: ['home_living_bedding', 'home_living_rugs'],
    Lifestyle_Dining_Brunch: ['home_living_kitchenware'],
    Detail_Textile_Weave: ['home_living_bedding', 'home_living_rugs'],
    Detail_Tableware_Finish: ['home_living_kitchenware'],
    Detail_Rug_Pile: ['home_living_rugs'],
    Detail_Linen_Hem: ['home_living_bedding'],
    Detail_Tableware_Glaze: ['home_living_kitchenware'],
    Studio_Bedding_Bedscape: ['home_living_bedding'],
    Studio_Kitchenware_Flatlay: ['home_living_kitchenware'],
  },
  food_beverage: {
    '*': 'ALL',
    Studio_Gourmet_Platter: ['food_beverage_gourmet'],
    Studio_Packaging_Line: ['food_beverage_gourmet', 'food_beverage_health', 'food_beverage_drinks'],
    Studio_Beverage_Pour: ['food_beverage_drinks'],
    Studio_Ingredient_Scatter: ['food_beverage_gourmet', 'food_beverage_health'],
    Studio_Pedestal_Display: ['food_beverage_gourmet', 'food_beverage_health'],
    Studio_Smoothie_Tower: ['food_beverage_health'],
    Studio_Coffee_BeanCascade: ['food_beverage_drinks'],
    Lifestyle_Breakfast_Table: ['food_beverage_health', 'food_beverage_drinks'],
    Lifestyle_CoffeeMoment: ['food_beverage_drinks'],
    Lifestyle_GiftHamper: ['food_beverage_gourmet'],
    Lifestyle_Picnic_Spread: ['food_beverage_gourmet', 'food_beverage_drinks'],
    Lifestyle_Kitchen_Prep: ['food_beverage_health', 'food_beverage_gourmet'],
    Detail_Texture_Food: ['food_beverage_gourmet', 'food_beverage_health'],
    Detail_Label_Bottle: ['food_beverage_drinks'],
    Detail_Pour_Splash: ['food_beverage_drinks'],
    Detail_Sliced_Texture: ['food_beverage_gourmet', 'food_beverage_health'],
    Detail_Label_Emboss: ['food_beverage_gourmet'],
  },
  kids_products: {
    '*': 'ALL',
    Studio_Apparel_Set: ['kids_products_apparel'],
    Studio_Stroller_Spotlight: ['kids_products_strollers'],
    Studio_Toy_Set: ['kids_products_toys'],
    Studio_Pastel_Pedestals: ['kids_products_apparel', 'kids_products_toys'],
    Studio_Suspended_Play: ['kids_products_toys'],
    Lifestyle_Nursery: ['kids_products_apparel', 'kids_products_strollers'],
    Lifestyle_Playtime: ['kids_products_toys', 'kids_products_apparel'],
    Lifestyle_Stroller_Walk: ['kids_products_strollers'],
    Lifestyle_Playroom_Shelves: ['kids_products_toys'],
    Lifestyle_Diaper_Station: ['kids_products_apparel', 'kids_products_strollers'],
    Detail_Fabric_Soft: ['kids_products_apparel'],
    Detail_Safety_Buckle: ['kids_products_strollers'],
    Detail_Toy_Texture: ['kids_products_toys'],
    Detail_Snap_Closure: ['kids_products_apparel'],
    Detail_Teether_Texture: ['kids_products_toys'],
    Studio_Stroller_CityGlow: ['kids_products_strollers'],
    Studio_Toy_ColorBurst: ['kids_products_toys'],
  },
  toys_hobbies: {
    '*': 'ALL',
    Studio_Brick_Scene: ['toys_hobbies_building_sets'],
    Studio_BoardGame_Display: ['toys_hobbies_board_games'],
    Studio_Modelcraft: ['toys_hobbies_modeling'],
    Studio_Game_Tower: ['toys_hobbies_board_games'],
    Studio_Diorama_Spotlight: ['toys_hobbies_modeling', 'toys_hobbies_building_sets'],
    Lifestyle_GameNight: ['toys_hobbies_board_games'],
    Lifestyle_HobbyDesk: ['toys_hobbies_modeling'],
    Lifestyle_Playroom: ['toys_hobbies_building_sets', 'toys_hobbies_board_games'],
    Lifestyle_Game_Table: ['toys_hobbies_board_games'],
    Lifestyle_Shelf_Display: ['toys_hobbies_modeling', 'toys_hobbies_building_sets'],
    Detail_Brick_Close: ['toys_hobbies_building_sets'],
    Detail_Card_Texture: ['toys_hobbies_board_games'],
    Detail_Paint_Brush: ['toys_hobbies_modeling'],
    Detail_Dice_Close: ['toys_hobbies_board_games'],
    Detail_Model_Surface: ['toys_hobbies_modeling'],
    Studio_BoardGame_Action: ['toys_hobbies_board_games'],
    Studio_Model_Lightbox: ['toys_hobbies_modeling'],
  },
  automotive: {
    '*': 'ALL',
    Studio_Tire_Profile: ['automotive_tires'],
    Studio_Care_Kit: ['automotive_accessories'],
    Studio_Oil_Bottle: ['automotive_fluids'],
    Studio_Wheel_Reflection: ['automotive_tires', 'automotive_accessories'],
    Studio_Detailing_Array: ['automotive_accessories'],
    Lifestyle_Garage: ['automotive_accessories', 'automotive_tires'],
    Lifestyle_Trunk_Organized: ['automotive_accessories'],
    Lifestyle_Car_Wash: ['automotive_tires', 'automotive_accessories'],
    Lifestyle_Detail_Garage: ['automotive_accessories'],
    Lifestyle_Trunk_Prep: ['automotive_fluids', 'automotive_accessories'],
    Detail_Tread_Close: ['automotive_tires'],
    Detail_Microfiber: ['automotive_accessories'],
    Detail_Oil_Pour: ['automotive_fluids'],
    Detail_Tread_Profile: ['automotive_tires'],
    Detail_Polish_Bead: ['automotive_accessories'],
    Studio_Tire_SnowStack: ['automotive_tires'],
    Studio_Detailing_Foam: ['automotive_accessories', 'automotive_fluids'],
  },
  pet_products: {
    '*': 'ALL',
    Studio_Pet_Food: ['pet_products_food'],
    Studio_Pet_Toy_Set: ['pet_products_toys'],
    Studio_Pet_Bed: ['pet_products_gear'],
    Studio_Treat_Jars: ['pet_products_food'],
    Studio_Grooming_Set: ['pet_products_gear'],
    Lifestyle_Kitchen_Feeding: ['pet_products_food'],
    Lifestyle_LivingRoom_Toys: ['pet_products_toys'],
    Lifestyle_Entry_Leash: ['pet_products_gear'],
    Lifestyle_Patio_Pet: ['pet_products_gear', 'pet_products_food'],
    Lifestyle_Pantry_Storage: ['pet_products_food'],
    Detail_Kibble_Close: ['pet_products_food'],
    Detail_Leash_Clip: ['pet_products_gear'],
    Detail_Bed_Stitch: ['pet_products_gear'],
    Detail_Treat_Texture: ['pet_products_food'],
    Detail_Collar_Hardware: ['pet_products_gear'],
    Studio_PetBed_Sunbeam: ['pet_products_gear'],
    Studio_Treat_Tower: ['pet_products_food'],
  },
  diy_tools: {
    '*': 'ALL',
    Studio_Tool_Set: ['diy_tools_hand'],
    Studio_PowerTool: ['diy_tools_repair'],
    Studio_Materials_Stack: ['diy_tools_materials'],
    Studio_CuttingMat_Flatlay: ['diy_tools_materials', 'diy_tools_hand'],
    Studio_Pegboard_Lighting: ['diy_tools_hand', 'diy_tools_repair'],
    Lifestyle_Workbench: ['diy_tools_hand', 'diy_tools_repair'],
    Lifestyle_DiyProject: ['diy_tools_repair', 'diy_tools_materials'],
    Lifestyle_ToolBag: ['diy_tools_hand'],
    Lifestyle_Renovation_Setup: ['diy_tools_repair'],
    Lifestyle_Truck_Organized: ['diy_tools_hand', 'diy_tools_repair'],
    Detail_Blade_Edge: ['diy_tools_hand'],
    Detail_Handle_Grip: ['diy_tools_hand'],
    Detail_Fastener_Assortment: ['diy_tools_materials'],
    Detail_Sawtooth: ['diy_tools_hand', 'diy_tools_materials'],
    Detail_Handle_Texture: ['diy_tools_hand', 'diy_tools_repair'],
    Studio_Workshop_Sparks: ['diy_tools_repair'],
    Studio_Material_ColorGrid: ['diy_tools_materials'],
  },
  books_education: {
    '*': 'ALL',
    Studio_Book_Stack: ['books_education_print'],
    Studio_Open_Book: ['books_education_print'],
    Studio_Course_Kit: ['books_education_courses', 'books_education_ebooks'],
    Studio_Color_Stack: ['books_education_print', 'books_education_courses'],
    Studio_Open_Spreads: ['books_education_print', 'books_education_ebooks'],
    Lifestyle_ReadingNook: ['books_education_print'],
    Lifestyle_WorkshopDesk: ['books_education_courses', 'books_education_ebooks'],
    Lifestyle_StudyFlatlay: ['books_education_print', 'books_education_courses', 'books_education_ebooks'],
    Lifestyle_Reading_Window: ['books_education_print', 'books_education_ebooks'],
    Lifestyle_Classroom_Supplies: ['books_education_courses'],
    Detail_Book_Spine: ['books_education_print'],
    Detail_Page_Texture: ['books_education_print'],
    Detail_Device_Interface: ['books_education_ebooks', 'books_education_courses'],
    Detail_Spine_Foil: ['books_education_print'],
    Detail_Paper_Edge: ['books_education_print'],
    Studio_Rainbow_Bookcase: ['books_education_print'],
    Studio_Digital_CourseHub: ['books_education_courses', 'books_education_ebooks'],
  },
  music_instruments: {
    '*': 'ALL',
    Studio_Guitar_Stand: ['music_instruments_guitars'],
    Studio_DJ_Gear: ['music_instruments_dj'],
    Studio_Vinyl_Stack: ['music_instruments_vinyl'],
    Studio_Stage_Beams: ['music_instruments_guitars', 'music_instruments_dj'],
    Studio_Pedalboard_Display: ['music_instruments_guitars'],
    Lifestyle_StudioCorner: ['music_instruments_guitars'],
    Lifestyle_LivingRoom_Session: ['music_instruments_guitars', 'music_instruments_vinyl'],
    Lifestyle_DJ_Setup: ['music_instruments_dj'],
    Lifestyle_Stage_Warmup: ['music_instruments_guitars', 'music_instruments_dj'],
    Lifestyle_Lounge_Session: ['music_instruments_vinyl'],
    Detail_String_Close: ['music_instruments_guitars'],
    Detail_Knob_Fader: ['music_instruments_dj'],
    Detail_Vinyl_Groove: ['music_instruments_vinyl'],
    Detail_String_Windings: ['music_instruments_guitars'],
    Detail_Knob_Indicator: ['music_instruments_dj', 'music_instruments_vinyl'],
    Studio_Guitar_AmpGlow: ['music_instruments_guitars'],
    Studio_Vinyl_Spin: ['music_instruments_vinyl'],
  },
  outdoor_travel: {
    '*': 'ALL',
    Studio_Backpack_Hero: ['outdoor_travel_backpacks'],
    Studio_Tent_Display: ['outdoor_travel_camping'],
    Studio_Gear_Flatlay: ['outdoor_travel_accessories', 'outdoor_travel_camping'],
    Studio_Rope_Suspension: ['outdoor_travel_accessories'],
    Studio_Terrain_Podium: ['outdoor_travel_camping', 'outdoor_travel_accessories'],
    Lifestyle_Campsite: ['outdoor_travel_camping'],
    Lifestyle_Trailhead: ['outdoor_travel_backpacks'],
    Lifestyle_Packing: ['outdoor_travel_backpacks', 'outdoor_travel_accessories'],
    Lifestyle_Trailhead_Panorama: ['outdoor_travel_camping'],
    Lifestyle_Campsite_Table: ['outdoor_travel_camping', 'outdoor_travel_accessories'],
    Detail_Fabric_Weatherproof: ['outdoor_travel_backpacks', 'outdoor_travel_accessories'],
    Detail_Buckle_System: ['outdoor_travel_backpacks'],
    Detail_Tent_Pole: ['outdoor_travel_camping'],
    Detail_Fabric_Coating: ['outdoor_travel_accessories', 'outdoor_travel_camping'],
    Detail_Rope_Braid: ['outdoor_travel_accessories'],
    Studio_Tent_Starfield: ['outdoor_travel_camping'],
    Studio_Backpack_RainShield: ['outdoor_travel_backpacks'],
  },
  seasonal_products: {
    '*': 'ALL',
    Studio_Holiday_Display: ['seasonal_products_holiday'],
    Studio_Costume_Mannequin: ['seasonal_products_halloween'],
    Studio_Summer_Set: ['seasonal_products_summer'],
    Studio_Winter_Wonderland: ['seasonal_products_holiday'],
    Studio_Seasonal_Flatlay: ['seasonal_products_holiday', 'seasonal_products_halloween', 'seasonal_products_summer'],
    Lifestyle_Holiday_Table: ['seasonal_products_holiday'],
    Lifestyle_Halloween_Display: ['seasonal_products_halloween'],
    Lifestyle_Summer_Beach: ['seasonal_products_summer'],
    Lifestyle_Winter_Mantle: ['seasonal_products_holiday'],
    Lifestyle_Spring_Garden: ['seasonal_products_holiday', 'seasonal_products_summer'],
    Detail_Ornament: ['seasonal_products_holiday'],
    Detail_Costume_Fabric: ['seasonal_products_halloween'],
    Detail_Summer_Texture: ['seasonal_products_summer'],
    Detail_Ornament_Sparkle: ['seasonal_products_holiday'],
    Detail_Costume_Accessory: ['seasonal_products_halloween'],
    Studio_Halloween_Smoke: ['seasonal_products_halloween'],
    Studio_Summer_Poolside: ['seasonal_products_summer'],
  },
};


function applySubcategoryAssignments() {
  Object.entries(SUBCATEGORY_ASSIGNMENTS).forEach(([categoryId, assignment]) => {
    const definition = categories[categoryId];
    if (!definition) {
      return;
    }

    const subcategoryIds = (definition.subcategories || []).map((entry) => entry.id).filter(Boolean);
    const normalize = (value) => {
      ...
      if (Array.isArray(value)) {
        return value.filter((id) => subcategoryIds.includes(id));
      }
    ...
    const defaultIds = normalize(assignment['*']);

    Object.values(definition.groups || {}).forEach((groupPrompts) => {
      groupPrompts.forEach((prompt) => {
        const explicit = normalize(assignment[prompt.name]);
        const fallback = defaultIds.length > 0 ? defaultIds : subcategoryIds;
        const selected = explicit.length > 0 ? explicit : fallback;
        prompt.subcategoryIds = Array.isArray(selected) ? [...selected] : [];
      });
    });
  });
}
